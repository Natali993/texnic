      ...
      <section id="about" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6"><strong>У медичному центрі &laquo;Solis&raquo; пропонують послуги: </strong></h2>
              <ul className="text-lg text-gray-600 mb-6 space-y-2">
               <li>1. Лікаря-нарколога — лікування алкогольної залежності: зняття абстинентного симптому, проведення детоксикації організму, введення сучасних коректорів хворому для нейтралізації алкогольної залежності, імплантація препаратів пролонгованого класу (Дісульфірам і Еспіраль). Можливий виїзд лікаря додому до пацієнта за попередньою домовленістю (по м. Рівне).</li>
               <li>2. Нарколога — лікування наркотичної залежності, детокс, замісна терапія.</li>
               <li>3. Психіатра — лікування психічних розладів, депресій та неврозів.</li>
               <li>4. Телемедицина — консультуємо пацієнтів онлайн з питань психічного здоров&apos;я;</li>
               <li>5. Надання довідки-сертифіката нарколога-психіатра.</li>
               <li>6. Довідка 122-2/0 — нова послуга.</li>
              </ul>
