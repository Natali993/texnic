          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                1. Лікаря-нарколога — лікування алкогольної залежності: зняття абстинентного симптому, проведення детоксикації організму, введення сучасних коректорів хворому для нейтралізації алкогольної залежності, імплантація препаратів пролонгованого класу (Дісульфірам і Еспіраль). Можливий виїзд лікаря додому до пацієнта за попередньою домовленістю (по м. Рівне).
                2. Нарколога — лікування наркотичної залежності, детокс, замісна терапія.
                3.   Психіатра — лікування психічних розладів, депресій та неврозів.
                4. Телемедицина — консультуємо пацієнтів онлайн з питань психічного здоров'я;
                5.  Надання довідки-сертифіката нарколога-психіатра.
                6.Довідка 122-2/0 —  нова послуга.
              </p>
